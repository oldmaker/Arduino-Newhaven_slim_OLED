 ...
 *
 * This sketch displays "Hello World!" and a timer on the OLED.
 *
...
void loop(void)
{
   oled.setCursor(2, 1);                        // Set the cursor to column 0, line 1
                                                //  (note: line 1 is the second row, since counting begins with 0)
   oled.print(millis()/1000);                   // Print the number of seconds since reset
   oled.print(" seconds");
}
